...
illuminant_A = xyz_from_xy(0.44757, 0.40745)
illuminant_LEDB3 = xyz_from_xy(0.3756, 0.3723)
illuminant_D50 = xyz_from_xy(0.34567, 0.35850)
...
cs_srgb_custom = ColourSystem(red=xyz_from_xy(0.64, 0.33),
                       green=xyz_from_xy(0.30, 0.60),
                       blue=xyz_from_xy(0.15, 0.06),
